...
namespace ImGui
{
    ...
    // - IMPORTANT: SINCE 1.78 (JULY 2020): Only call a matching EndChild() if BeginChild() returned true!.
    // - IMPORTANT: BEFORE 1.78 (JULY 2020): The return value of BeginChild() was inconsistent with most other BeginXXX()
